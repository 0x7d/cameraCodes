...
#define HAL_PIXEL_FORMAT_YUV420_SP	 0x21
#define ANDROID_HAL_PIXEL_FORMAT_YCbCr_422_I 0x14 /* YUV 422 package: YUYV, YUY2 */
namespace android {
...
public:
	...
	enum DisplayStates {
		DISPLAY_INIT = 0, DISPLAY_STARTED, DISPLAY_STOPPED, DISPLAY_EXITED
	};
...
public:
	...
	virtual int enableDisplay(int width, int height, struct timeval *refTime =
			NULL, S3DParameters *s3dParams = NULL);
...
public:
	...
	public:
		...
		enum DisplayThreadCommands {
			DISPLAY_START, DISPLAY_STOP, DISPLAY_FRAME, DISPLAY_EXIT
		};
	};
