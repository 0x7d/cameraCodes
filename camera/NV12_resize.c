...
{
  LOGE("VT_resizeFrame_Video_opt2_lp+");
  ...
  if(i_img_ptr->uWidth == o_img_ptr->uWidth)
	{
		if(i_img_ptr->uHeight == o_img_ptr->uHeight)
			{
				LOGE("************************f(i_img_ptr->uHeight == o_img_ptr->uHeight) are same *********************\n");
				LOGE("************************(i_img_ptr->width == %d" , i_img_ptr->uWidth );
				LOGE("************************(i_img_ptr->uHeight == %d" , i_img_ptr->uHeight );
				LOGE("************************(o_img_ptr->width == %d" ,o_img_ptr->uWidth );
				LOGE("************************(o_img_ptr->uHeight == %d" , o_img_ptr->uHeight );
			}
	}
